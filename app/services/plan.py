...
2. **Timeline**: Summarize the distribution of time across phases (e.g., 20% planning, 60% coding, 20% testing) and member distribution (how many people for each task/role).
...
{{
    ...
    "timeline_summary": "Timeline summary (e.g., Phase 1: 4 hours, Phase 2: 12 hours...), Member distribution (how many people for each task/role)",
