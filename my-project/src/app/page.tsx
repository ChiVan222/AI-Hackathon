...
export default function Home() {
  ...
  const handleDirectPlanSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setPlanLoading(true);
    setError('');
    setDetailedPlan(null);
    ...
    try {
      const ideaConcept: IdeaConcept = {
        name: directIdeaName,
        description: directIdeaDescription,
        target_audience: directTargetAudience || undefined,
      };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        {/* Tab 2: Direct Project Planner */}
        {activeTab === 'planner' && (
          <>
            {/* Direct Idea Input Form */}
            <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-gray-100">
              <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center">
                <span className="text-3xl mr-3">💡</span>
                Enter Your Project Idea
              </h2>
              <form onSubmit={handleDirectPlanSubmit} className="space-y-6">
                <div>
                  <label htmlFor="ideaName" className="block text-sm font-semibold text-gray-700 mb-2">
                    Idea Name *
                  </label>
                  <input
                    id="ideaName"
                    type="text"
                    value={directIdeaName}
                    onChange={(e) => setDirectIdeaName(e.target.value)}
                ...
                <div>
                  <label htmlFor="ideaDescription" className="block text-sm font-semibold text-gray-700 mb-2">
                    Idea Description *
                  </label>
                  <textarea
                    id="ideaDescription"
                    value={directIdeaDescription}
                    onChange={(e) => setDirectIdeaDescription(e.target.value)}
                ...
                <div>
                  ...
                  <input
                    id="targetAudience"
                    type="text"
                    value={directTargetAudience}
                    onChange={(e) => setDirectTargetAudience(e.target.value)}
                ...
                <div className="border-t pt-6">
                  <h3 className="text-lg font-semibold text-gray-700 mb-4">⚙️ Planning Parameters</h3>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label htmlFor="plannerTeamMembers" className="block text-sm font-medium text-gray-700 mb-2">
                        Team Members
                      </label>
                      <input
                        id="plannerTeamMembers"
                        type="number"
                        min="1"
                        max="20"
                        value={teamMembers}
                    ...
                    <div>
                      <label htmlFor="plannerDurationHours" className="block text-sm font-medium text-gray-700 mb-2">
                        Duration (hours)
                      </label>
                      <input
                        id="plannerDurationHours"
                        type="number"
                        min="1"
                        max="168"
                        value={durationHours}
                ...
                <button
                  type="submit"
                  disabled={planLoading || !directIdeaName || !directIdeaDescription}
                  className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white font-semibold py-3 px-6 rounded-lg hover:from-purple-700 hover:to-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-lg hover:shadow-xl"
                >
                  {planLoading ? (
                    <span className="flex items-center justify-center">
            ...
            {/* Detailed Plan Section for Direct Input */}
